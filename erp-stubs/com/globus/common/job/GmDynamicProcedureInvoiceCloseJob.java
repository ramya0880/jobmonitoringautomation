...
/**
 * POC-only job class - NOT part of the erpjobs source tree. Eighth demo
...
@Description(value="POC job: runs SP_ERP_INVOICE_CLOSE (marks INV-600 CLOSED) in ERP_INVOICE_CLOSE_TEST.",
            urls= {"http://www.globusmedical.com"})

public class GmDynamicProcedureInvoiceCloseJob extends GmActionJob implements SchedulableJob{
